...
public static class gui
{
	...
	public static extern void play_flipbook(Node node_p1, string animation_p2,
		Action<object, Node> complete_function_p3, ILuaTable play_properties_p4);
	...
	/// </summary>
	public static extern bool new_texture(string texture_p1, double width_p2, double height_p3, GuiTextureType type_p4,
		string buffer_p5, bool flip_p6, out double code_o1);


	/// <summary>
	///     @CSharpLua.Template = "gui.new_texture({0}, {1}, {2}, {3}, {4}, {5})"
	/// </summary>
	public static extern bool new_texture(Hash texture_p1, double width_p2, double height_p3, GuiTextureType type_p4,
		string buffer_p5, bool flip_p6, out double code_o1);
	...
	/// </summary>
	public static extern bool set_texture_data(string texture_p1, double width_p2, double height_p3,
		GuiTextureType type_p4, string buffer_p5, bool flip_p6);


	/// <summary>
	///     @CSharpLua.Template = "gui.set_texture_data({0}, {1}, {2}, {3}, {4}, {5})"
	/// </summary>
	public static extern bool set_texture_data(Hash texture_p1, double width_p2, double height_p3,
		GuiTextureType type_p4, string buffer_p5, bool flip_p6);
	...
	public static extern void play_particlefx(Node node_p1,
		Action<object, Hash, Hash, ParticleEmitterState> emitter_state_function_p2);
