...
public static class buffer
{
	...
	/// </summary>
	public static extern void copy_stream(BufferStream dst_p1, double dstoffset_p2, BufferStream src_p3,
		double srcoffset_p4, double count_p5);


	/// <summary>
	///     @CSharpLua.Template = "buffer.copy_buffer({0}, {1}, {2}, {3}, {4})"
	/// </summary>
	public static extern void copy_buffer(DataBuffer dst_p1, double dstoffset_p2, DataBuffer src_p3,
		double srcoffset_p4, double count_p5);
